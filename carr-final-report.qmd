...
### Model Description 
My model will synthesize the cloud phase and effective radii (sampled at the 1.6 $\mu$m band) in particular to determine how cloud phase and effective radii interact. 
...
prior_pred_dist <- tibble(sim_id = c(1:n_sim)) |> 
   mutate(b0 = rnorm(n_sim, log(23), log(5)),
          b1_0 = rstudent(n_sim, nu=2, mu=log(22/230), sigma=0.2), 
...
#### Posterior Predictive Distribution for mu
